...
public class SendMailRecommendationNonLogged extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		String subject = recommender+" "+actionText+" "+addRecText+" Especially to You on Recommendation Book";

		String text = "<span style=\"font-family: verdana, sans-serif; font-size: 18px; color: gray;\"><a href=\"http://recommendationbook.com/\"><img style=\"border: none; outline: none;\" width=\"110\" height=\"60\" src=\"http://recommendationbook.com/img/static/LogoTransparencia.png\" alt=\"Recommendation Book\" /></a><br /><br /><span style=\"color: GoldenRod; text-decoration: none;\">"+recommender+"</span> "+actionText+" <a style=\"color: GoldenRod; text-decoration: none;\" href=\"http://recommendationbook.com/"+page+".jsp?id="+addRec+"\">"+addRecText+"</a> Especially to You on <a style=\"color: GoldenRod; text-decoration: none;\" href=\"http://recommendationbook.com/\">Recommendation Book</a>";
