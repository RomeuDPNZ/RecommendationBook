...
<%
	...
	session.setAttribute("idWhoRecommendedTheEntity", ""+id+"");
	...
	session.setAttribute("idWhoRecommendedTheEntityAction", ""+action+"");
...
<% if(forRecommended.equals("true")) { %>
	...
	<jsp:include page="WhoRecommendedTheEntityRecs.jsp?page=1&forRecommended=true" flush="true" />
...
<meta name="keywords" content="Who Recommended the Entity <%= recommended.getName() %> on Recommendation Book" />
<meta name="description" content="Who Recommended the Entity <%= recommended.getName() %> on Recommendation Book" />
...
$(document).ready(function(){
	$(document).on("click", "tr.LoadMore", function() {
		...
		var posting = $.post("WhoRecommendedTheEntityRecs.jsp", {page: id});
...
<div class="Corpo">
	...
	<fieldset>
	<legend>Who Recommended the Entity <a class="SeeAll" href="Recommended.jsp?id=<%= id %>"><%= recommended.getName() %></a></legend>

			<table>
			<tbody>

				<jsp:include page="WhoRecommendedTheEntityRecs.jsp?page=1" flush="true" />
