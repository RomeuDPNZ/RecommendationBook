...
<% if((request.getParameter("name") == null) || (request.getParameter("email") == null) || (request.getParameter("birthday") == null) || (request.getParameter("gender") == null) || (request.getParameter("locale") == null)) { %>
...
<%
	...
	if(emailFound >= 1) {
		...
		/*
		 * Construct countryId From locale
		 */

		Locale localeOutro = Locale.forLanguageTag(locale.replace("_","-"));

		String country = localeOutro.getDisplayCountry(Locale.US);
		...
		*/
		...
		try {
			...
			recommender.setCountry(countryId.intValue());
