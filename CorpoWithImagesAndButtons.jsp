	...
	<div class="Corpo">
		<div class="Column">
			<fieldset>
				...
				out.println("<tr><th rowspan=\"3\"><a href=\"Recommended.jsp?id="+mr.getId()+"\"><img src=\"./img/user/"+imagemOutro+"\" alt=\""+mr.getName()+"\" width=\"150\" height=\"150\" /></a></th><td style=\"width: 100%\" class=\"LightGrayBorder\"><a href=\"Recommended.jsp?id="+mr.getId()+"\">"+mr.getName()+"</a></td></tr><tr><td class=\"LightGrayBorder\"><span class=\"green\">"+mr.getRecommendations()+" "+r+"</span></td></tr><tr><td class=\"LightGrayBorder\">");
 pageContext.include("MakeButtonRecommend.jsp?id="+mr.getId()+"&table=Recommended&width=100");
out.println("</td></tr>");
				}
...
out.println("<tr><td colspan=\"2\" class=\"LightGrayBorder\"><a href=\"MostRecommended.jsp?type=Person\">See The 1000 Most Recommended Persons</a></td></tr>");
			...
			<fieldset>
				...
				out.println("<tr><th rowspan=\"3\"><a href=\"Recommended.jsp?id="+mr.getId()+"\"><img src=\"./img/user/"+imagemOutro+"\" alt=\""+mr.getName()+"\" width=\"150\" height=\"150\" /></a></th><td style=\"width: 100%\" class=\"LightGrayBorder\"><a href=\"Recommended.jsp?id="+mr.getId()+"\">"+mr.getName()+"</a></td></tr><tr><td class=\"LightGrayBorder\"><span class=\"green\">"+mr.getRecommendations()+" "+r+"</span></td></tr><tr><td class=\"LightGrayBorder\">");
 pageContext.include("MakeButtonRecommend.jsp?id="+mr.getId()+"&table=Recommended&width=100");
 pageContext.include("MakeButtonTODO.jsp?id="+mr.getId()+"&width=100");
out.println("</td></tr>");
				}
...
out.println("<tr><td colspan=\"2\" class=\"LightGrayBorder\"><a href=\"MostRecommended.jsp?type=Place\">See The 1000 Most Recommended Places</a></td></tr>");
			...
			<fieldset>
				...
				out.println("<tr><th rowspan=\"3\"><a href=\"Recommender.jsp?id="+mr.getId()+"\"><img src=\"./img/user/"+imagemOutro+"\" alt=\""+mr.getName()+"\" width=\"150\" height=\"150\" /></a></th><td style=\"width: 100%\" class=\"LightGrayBorder\"><a href=\"Recommender.jsp?id="+mr.getId()+"\">"+mr.getName()+"</a></td></tr><tr><td class=\"LightGrayBorder\"><span class=\"green\">"+mr.getRecommendations()+" "+r+"</span></td></tr><tr><td class=\"LightGrayBorder\">");
 pageContext.include("MakeButtonRecommend.jsp?id="+mr.getId()+"&table=Recommender&width=100");
 pageContext.include("MakeButtonSubscribe.jsp?recommender="+mr.getId()+"&width=100");
out.println("</td></tr>");
