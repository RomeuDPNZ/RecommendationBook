...
<%
	...
	Long id = Long.valueOf((String) session.getAttribute("idSubscribedToWho"));
	Boolean ok = true;
	...
	try {
			PreparedStatement ps = db.conexao.prepareStatement("SELECT recommender as recommender, (SELECT nickName from Recommender WHERE id=recommender) as nickName FROM Subscription WHERE subscriber = ? LIMIT ?,?");
			ps.setLong(1, id);
