...
<h1 class="Action">You Are Now Updating A Recommender...</h1>
				...
				<tr><td class="tdLeft SpaceForFields"><span class="Bold">Nickname</span></td></tr>
				<tr><td class="tdLeft"><% if(session.getAttribute("nickNameS") != null) { out.print(session.getAttribute("nickNameS")); } %></td></tr>
				...
				<tr><td class="tdLeft"><input type="file" class="required" name="image" accept="image/*" id="PreviewImage" /><div id="DivImagePreview"></div></td></tr>
...
<% } %>
				...
				<tr><td class="tdLeft"><select class="required" id="sex" name="sex"><jsp:include page="Sex.jsp" flush="true" /></select></td></tr>
...
<% } %>
				...
				<tr><td class="tdLeft"><select class="required" id="year" name="year"><jsp:include page="Years.jsp?from=now&to=1900&timeline=false" flush="true" /></select></td></tr>
				<tr><td class="tdLeft"><select class="required" id="month" name="month"><jsp:include page="Months.jsp" flush="true" /></select></td></tr>
				<tr><td class="tdLeft"><select class="required" id="day" name="day"><jsp:include page="Days.jsp" flush="true" /></select></td></tr>
...
<% } %>
				...
				<tr><td class="tdLeft SpaceForFields">About Yourself <div class="TextAreaCounter"></div></td></tr>
				<tr><td class="tdLeft"><textarea id="TAAbout" class="required" name="about" cols="50" style="height: 800px; max-height: 800px;"><% if(session.getAttribute("aboutS") != null) { out.print(session.getAttribute("aboutS")); } %></textarea></td></tr>
...
<% } %>
				...
				<tr><td class="tdLeft SpaceForFields">Password</td></tr>
				<tr><td class="tdLeft"><input type="password" class="required" id="password" name="password" size="20" value=""></td></tr>
				<tr><td class="tdLeft">If You Don't Wanna Change Your Password Leave the Password Fields Empty.</td></tr>
...
<% } %>
				...
				<tr><td class="tdLeft SpaceForFields">Retype Password</td></tr>
				<tr><td class="tdLeft"><input type="password" class="required" id="rpassword" name="rpassword" size="20" value=""></td></tr>
				<tr><td class="tdLeft">The Password Must Have at Least 6 Letters: a-z A-Z, at Least 2 Numbers: 0-9 and at Least 1 Punctuation From The Following: # + - _</td></tr>
