...
<span class="Action Bold">Fields in Bold Are Required</span>
				...
				<tr><td class="tdLeft"><input type="text" class="required" name="name" value="<% if(session.getAttribute("nameS") != null) { out.print(session.getAttribute("nameS")); } %>" /></td></tr>
				<tr><td class="tdLeft"><span class="CantBeChanged">Attention. You Cannot Change the Name Later. Type Carefully.</span></td></tr>
...
<% } %>
				...
				<tr><td class="tdLeft SpaceForFields">Image</td></tr>
				<tr><td class="tdLeft"><input type="file" class="required" name="image" accept="image/*" id="PreviewImage" /></td></tr><tr><td><div id="DivImagePreview"></div></td></tr>
				<tr><td class="tdLeft"><span class="Nickname">Image Cannot Be Bigger Than 50Kb and Only .jpg File Extensions Are Accepted</span></td></tr>
...
<% } %>
				...
				<tr><td class="tdLeft"><input type="text" class="required" name="description" value="<% if(session.getAttribute("descriptionS") != null) { out.print(session.getAttribute("descriptionS")); } %>" /></td></tr>
...
<% } %>
				...
				</select></td></tr><tr><td class="tdLeft"><span class="CantBeChanged">Attention. You Cannot Change the Type Later. Choose Carefully.</span></td></tr>
...
<% } %>
				...
				<tr><td class="tdLeft SpaceForFields"><span class="Bold">Country</span></td></tr><tr><td class="tdLeft"><select class="required" name="country">
...
<% } %>
				...
				<tr><td class="tdLeft"><input type="text" class="required" name="officialWebsite" value="<% if(session.getAttribute("officialWebsiteS") != null) { out.print(session.getAttribute("officialWebsiteS")); } %>" /></td></tr>
...
<% } %>
				...
				<tr><td class="tdLeft"><textarea id="TAAbout" class="required" name="about" style="height: 800px; max-height: 800px;"><% if(session.getAttribute("aboutS") != null) { out.print(session.getAttribute("aboutS")); } %></textarea></td></tr>
...
<% if(recs >= maxRecs) { %>
				...
				<tr><td class="tdLeft"><input type="hidden" name="WithCaptcha" value="true" />
<%
...
%>
				...
				<tr><td><span class="tdLeft Nickname">You Are Being Asked To Insert Captcha Because You Added More Than <%= maxRecs.toString() %> Entities In The Last Month.</span></td></tr>
...
<% } %>
				...
				<tr><td class="SpaceForFields"><input type="submit" value="Add To Recommendation Book" /></td></tr>
				</tbody>
				</table>
		</form>
<% } else { %>
